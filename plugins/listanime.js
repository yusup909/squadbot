...
10. Boku No Pico`
 const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
     templateMessage: {
         hydratedTemplate: {
           hydratedContentText: animenye,
           locationMessage: { 
           jpegThumbnail: fs.readFileSync('./media/listanime.jpg') },           
           hydratedFooterText: wm,
           hydratedButtons: [{
             urlButton: {
               displayText: 'List Anime Lain',
               url: 'isekai'
             }
...
handler.command = /^(listanime|animelist)$/i
