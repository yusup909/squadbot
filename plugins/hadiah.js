...
let handler = async (m, { conn, usedPrefix, text }) => {
	    let time = global.db.data.users[m.sender].lastminingh + 3600000
  if (new Date - global.db.data.users[m.sender].lastminingh< 3600000) throw `Anda sudah mengambil hadiah\ntunggu selama ${msToTime(time - new Date())} lagi`
	...
	global.db.data.users[m.sender].lastminingh = new Date * 1
